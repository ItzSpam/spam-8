...
client.user.setGame(`Vàmpire`,"http://twitch.tv/S-F")
  console.log('')
  console.log('')
  console.log('╔[═════════════════════════════════════════════════════════════════]╗')
...
if (message.content.startsWith('-bc')){
 if (message.author.id !== '418457005074677784') return message.reply('** هذا الأمر قفط لصاحب البوت و شكراًً **')
 if(!message.author.id === '418457005074677784') return;
...
client.on('message', message => {
var prefix = "-";
      if(message.content === prefix + "hchat") {
      if(!message.channel.guild) return;
...
client.on('message', message => {
var prefix = "-";
      if(message.content === prefix + "schat") {
      if(!message.channel.guild) return;
...
client.users.get("418457005074677784").send(
    "\n" + "**" + "● السيرفر :" + "**" +
    "\n" + "**" + "» " + message.guild.name + "**" +
    "\n" + "**" + " ● المرسل : " + "**" +
    "\n" + "**" + "» " + message.author.tag + "**" +
...
client.on('message', message => { 
    ...
    .setFooter(`Vàmpire`, 'https://images-ext-2.discordapp.net/external/JpyzxW2wMRG2874gSTdNTpC_q9AHl8x8V4SMmtRtlVk/https/orcid.org/sites/default/files/files/ID_symbol_B-W_128x128.gif')                                 
